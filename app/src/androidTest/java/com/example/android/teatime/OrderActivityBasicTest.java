...
public class OrderActivityBasicTest {
    ...
    public void clickIncrementButton_ChangesQuantityAndCost() {
        ...
        // Verify that the increment button incremented the quantity by 1
    ...
    public void clickDecrementButton_ChangesQuantityAndCost() {
        ...
        // Me: try to set a new value (failed to run the test)
        //onView((withId(R.id.quantity_text_view))).perform(typeTextIntoFocusedView("2"));
